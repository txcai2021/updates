...
namespace SIMTech.APS.Resource.API.Controllers
{
    ...
    public class ResourceController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ResourcePM>>> GetAllResources()
        {
            ...
            var resources = await _resourceRepository.GetQueryAsync(x => x.Category==null || x.Category =="Machine");
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<IEnumerable<ResourcePM>>> GetAllFixtures()
        {

            var resources = await _resourceRepository.GetQueryAsync(x => x.Category != null || x.Category == "Fixture");
        ...
        public async Task<ActionResult<ResourceBlockoutPM>> AddMachineBlockout([FromBody] ResourceBlockoutPM blockoutPM)
        {
            ...
            blockoutPM.EquipmentBlockOutID = (a!=null?a.Id: blockout.Id);
        ...
        public async Task<IActionResult> UpdateResource(int id, [FromBody] ResourcePM equipmentPM)
        {
            ...
            existingEquipment.Float2 = updatingEquipment.Float2;
